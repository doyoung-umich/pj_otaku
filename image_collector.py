...
# Load users table
df_characters = pd.read_csv("/Users/matsuwakajunko/Downloads/characters_498_titles")
...
# # check
print("total number of images: ", len(character_urls))
# character_urls = character_urls[40:45]
# character_ids = character_ids[40:45]
# print(character_urls, character_ids)
...
for id, url in zip(character_ids, character_urls):
    ...
    try:
        ...
        image = d.find_element(By.TAG_NAME, "img")
        if image:
            with open(f"/Users/matsuwakajunko/Downloads/character_images/{id}.png", "wb") as file:
                file.write(image.screenshot_as_png)
    except:
        print("retrieval error at user_id: ", id)
