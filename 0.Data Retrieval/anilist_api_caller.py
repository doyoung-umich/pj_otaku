...
def process_lists(media_list, list_array):
    '''
    func to handle "media_list" table
    :param media_list: info of 1 media list
    :param list_array: globally declared array
    :return: doesn't return anything, but modifies global list_array where each element is a dict of media list information
    '''
    for l in media_list:
...
def process_characters(media, chara_array):
    '''
    func to handle "characters" table
    :param media: info of 1 media, and each media contains info about 1 character
    :param chara_array: globally declared array
    :return: doesn't return anything, but modifies global chara_array where each element is a dict of character information
    '''
    for m in media:
